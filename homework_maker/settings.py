"""
Django settings for homework_maker project.
...
def handle_production():
    ...
    os.chdir('/var/www/html/homework_maker/homework_maker-master')
    WSGI_APPLICATION = 'homework_maker.wsgi.application'
...
ROOT_URLCONF = 'homework_maker.urls'
